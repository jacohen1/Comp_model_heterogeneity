...
# rd <- read.csv("RD_isometric.csv", header = FALSE)
# dd <- read.csv("DD_isometric.csv", header = FALSE)
# 
...
# 
# write.csv(rd, file = "RD_isometric.csv", row.names = FALSE)
# write.csv(dd, file = "DD_isometric.csv", row.names = FALSE)

####Read in data####
rd <- read.csv("RD_isometric.csv", header = TRUE)
dd <- read.csv("DD_isometric.csv", header = TRUE)
...
####Save files as csv####
write.csv(rd, file = "RD_het_R0_isometric.csv", row.names = FALSE)
write.csv(dd, file = "DD_het_R0_isometric.csv", row.names = FALSE)
